...
class Solr8TestCase(Solr4xTestCase):

    version = 8

    def create_sample_download_directories(self):
        # Create Solr 8 download package directory structure
    ...
    def test_singlecore_install(self):
        ...
        self.assertIn("solr: No cores option defined. Using collection1.", output)
        self.assertIn("collection1: Generated file 'solrconfig.xml'", output)
